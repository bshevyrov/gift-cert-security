...
import com.epam.esm.veiw.model.admin.AdminGiftCertificateModelAssembler;
 ...
 */
@RestController
@RequestMapping(value = "/api/v1/admin/gifts",
        consumes = MediaType.APPLICATION_JSON_VALUE,
        produces = MediaType.APPLICATION_JSON_VALUE)
@Validated
@RequiredArgsConstructor
public class AdminGiftCertificateController {
    private final AdminGiftCertificateModelAssembler giftCertificateModelAssembler;
